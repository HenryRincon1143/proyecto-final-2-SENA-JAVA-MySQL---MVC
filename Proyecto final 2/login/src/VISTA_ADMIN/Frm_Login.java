...
public class Frm_Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_queja_login = new javax.swing.JButton();
        ...
        btn_queja_login.setBackground(new java.awt.Color(255, 87, 0));
        btn_queja_login.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        btn_queja_login.setForeground(new java.awt.Color(255, 255, 255));
        btn_queja_login.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/insertar (1).png"))); // NOI18N
        btn_queja_login.setText("Queja");
        btn_queja_login.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 51, 51)));
        btn_queja_login.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_queja_loginActionPerformed(evt);
            }
        });
        bg.add(btn_queja_login, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 320, 140, 50));
        ...
        bg.add(btn_ingresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 320, 160, 50));
    ...
    private void btn_queja_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_queja_loginActionPerformed
        ...
        Contol.iniciar();
        frm_queja.setVisible(true);
    }//GEN-LAST:event_btn_queja_loginActionPerformed
    ...
    public javax.swing.JButton btn_queja_login;
