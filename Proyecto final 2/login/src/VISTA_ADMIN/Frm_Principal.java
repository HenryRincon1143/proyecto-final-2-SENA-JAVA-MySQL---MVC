...
import CONTROLADOR_ADMIN.Control_Frm_quejas;
...
public class Frm_Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        sub_lista_estudiante = new javax.swing.JMenuItem();
        Menu_Profesor = new javax.swing.JMenu();
        sub_lista_profesores = new javax.swing.JMenuItem();
        jMenu1 = new javax.swing.JMenu();
        sub_lista_notas = new javax.swing.JMenuItem();
        ...
        jPanel1.add(lbl_usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 290, 170, 30));
        ...
        BARRA_MENU.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        iten_FormularioSession.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        ...
        iten_FormularioSession.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        iten_agregar.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jMenuItem2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/anadir.png"))); // NOI18N
        ...
        Menu_matricular.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/agregar (2).png"))); // NOI18N
        Menu_matricular.setText("MATRICULAR ESTUDIANTE");
        Menu_matricular.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        Menu_Estudiante.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        sub_lista_estudiante.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        sub_lista_estudiante.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/archivo.png"))); // NOI18N
        sub_lista_estudiante.setText("Listar   ");
        sub_lista_estudiante.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        sub_lista_estudiante.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sub_lista_estudianteActionPerformed(evt);
            }
        });
        Menu_Estudiante.add(sub_lista_estudiante);
        ...
        sub_lista_profesores.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        sub_lista_profesores.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/archivo.png"))); // NOI18N
        sub_lista_profesores.setText("Listar    ");
        sub_lista_profesores.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sub_lista_profesoresActionPerformed(evt);
            }
        });
        Menu_Profesor.add(sub_lista_profesores);

        BARRA_MENU.add(Menu_Profesor);

        jMenu1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/show.png"))); // NOI18N
        jMenu1.setText(" NOTAS");
        jMenu1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jMenu1.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N

        sub_lista_notas.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        sub_lista_notas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/archivo.png"))); // NOI18N
        sub_lista_notas.setText("Ver    ");
        sub_lista_notas.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        sub_lista_notas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sub_lista_notasActionPerformed(evt);
            }
        });
        jMenu1.add(sub_lista_notas);

        BARRA_MENU.add(jMenu1);

        jMenu2.setText(" QUEJAS Y PETICIONES");
...
//      ImageIcon imagen = new ImageIcon("src/Imagenes/LOgo.jpg");
    ...
    private void sub_lista_estudianteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sub_lista_estudianteActionPerformed
        Frm_Consulta_Profesores frm_profe = new Frm_Consulta_Profesores(null, true);
        ...
        Usuario usuario = new Usuario(); 
       Control_Frm_consulta_Profesores control = new Control_Frm_consulta_Profesores(usuario, metodo, frm_profe, frm_notas, frm_estu);
       control.iniciar();
       frm_estu.setVisible(true);
                
    }//GEN-LAST:event_sub_lista_estudianteActionPerformed

    private void sub_lista_profesoresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sub_lista_profesoresActionPerformed
        Frm_Consulta_Profesores frm_profe = new Frm_Consulta_Profesores(null, true);
        Frm_reporte_notas frm_notas = new Frm_reporte_notas(null, true);
        Frm_consultar_estudiantes frm_estu = new Frm_consultar_estudiantes(null, true);
        Metodo_consultar_profesores_y_estudantes metodo = new Metodo_consultar_profesores_y_estudantes();
    ...
    }//GEN-LAST:event_sub_lista_profesoresActionPerformed
    ...
    private void sub_lista_notasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sub_lista_notasActionPerformed
        Frm_Consulta_Profesores frm_profe = new Frm_Consulta_Profesores(null, true);
        Frm_reporte_notas frm_notas = new Frm_reporte_notas(null, true);
        Frm_consultar_estudiantes frm_estu = new Frm_consultar_estudiantes(null, true);
        Metodo_consultar_profesores_y_estudantes metodo = new Metodo_consultar_profesores_y_estudantes();
    ...
    }//GEN-LAST:event_sub_lista_notasActionPerformed
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        Usuario usuario = new Usuario();
        Frm_queja frm_queja = new Frm_queja(this, true);
        Frm_recibir_queja Frm_recibir_queja = new Frm_recibir_queja(null, true);
        Metodo_ingreso_Login MetodoLogin = new Metodo_ingreso_Login();
        
        Control_Frm_quejas Contol = new Control_Frm_quejas(usuario, frm_queja, Frm_recibir_queja, MetodoLogin);
        Contol.iniciar();
        Frm_recibir_queja.setVisible(true);
...
//        //</editor-fold>
    ...
    private javax.swing.JMenuItem sub_lista_estudiante;
    private javax.swing.JMenuItem sub_lista_notas;
    private javax.swing.JMenuItem sub_lista_profesores;
