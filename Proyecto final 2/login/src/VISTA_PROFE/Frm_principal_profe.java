...
//      ImageIcon imagen = new ImageIcon("src/Imagenes/LOgo.jpg");
    ...
    private void initComponents() {
        ...
        panel_profe.add(lbl_imagen, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 210, 200));

        jLabel3.setFont(new java.awt.Font("Arial", 1, 22)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("PROFESOR");
        panel_profe.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 10, 170, 40));

        btn_notas.setBackground(new java.awt.Color(102, 102, 102));
        btn_notas.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        ...
        panel_profe.add(btn_notas, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 450, 130, 40));
        ...
        panel_profe.add(btn_salir, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 570, 150, 60));
        ...
        panel_profe.add(lbl_usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 260, 170, 30));

        btn_ver_horario.setBackground(new java.awt.Color(102, 102, 102));
        ...
        panel_profe.add(btn_ver_horario, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 510, 130, 40));

        getContentPane().add(panel_profe, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 240, 710));
        ...
        getContentPane().add(lbl_fondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(246, 60, 1170, 710));
