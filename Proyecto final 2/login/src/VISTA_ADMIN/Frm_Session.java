...
public class Frm_Session extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cbx_roles.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione", "Administrador", "Profesor", "Estudiante" }));
        ...
        cbx_opcion.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
